...
class LottoController {
    ...
    def contentMarkSix() { //六合彩介紹
        ...
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab03.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistoryMarkSix() { //六合彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistoryMarkSix", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "1",
                                                          ...
                                                          pType     : params.pType, title: g.message(code: "lotto.tab03.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinueMarkSix() { //六合連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinueMarkSix", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab03.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeatMarkSix() { //六合彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeatMarkSix", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab03.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumberMarkSix() { //六合彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumberMarkSix", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             ...
                                                             pType     : params.pType, title: g.message(code: "lotto.tab03.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def contentLotto740() { //大福彩介紹
        params.pType = "102"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab04.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistoryLotto740() { //大福彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistoryLotto740", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab04.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinueLotto740() { //大福彩連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinueLotto740", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab04.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeatLotto740() { //大福彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeatLotto740", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab04.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumberLotto740() { //大福彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumberLotto740", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab04.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def contentSuperLotto638() { //威力彩介紹
        params.pType = "103"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab05.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistorySuperLotto638() { //威力彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistorySuperLotto638", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory2", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnsSPNOs: vHistoryData.columnsSPNOs, showSpBtn: "0",
                                                          ...
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab05.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinueSuperLotto638() { //威力彩連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinueSuperLotto638", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue2", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnsSPNOs: vHistoryData.columnsSPNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab05.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeatSuperLotto638() { //威力彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeatSuperLotto638", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat2", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnsSPNOs: vHistoryData.columnsSPNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab05.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumberSuperLotto638() { //威力彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumberSuperLotto638", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber2", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnsSPNOs: vHistoryData.columnsSPNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab05.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def content38M6() { //38樂合彩介紹
        params.pType = "104"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab06.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistory38M6() { //38樂合彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistory38M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab06.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinue38M6() { //38樂合彩連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinue38M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab06.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeat38M6() { //38樂合彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeat38M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab06.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumber38M6() { //38樂合彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumber38M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab06.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def contentLotto649() { //大樂透介紹
        params.pType = "105"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab07.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistoryLotto649() { //大樂透歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistoryLotto649", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "1",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab07.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinueLotto649() { //大樂透連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinueLotto649", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab07.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeatLotto649() { //大樂透連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeatLotto649", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab07.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumberLotto649() { //大樂透尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumberLotto649", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab07.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def content49M6() { //49樂合彩介紹
        params.pType = "106"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab08.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistory49M6() { //49樂合彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistory49M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab08.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinue49M6() { //49樂合彩連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinue49M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab08.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeat49M6() { //49樂合彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeat49M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab08.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumber49M6() { //49樂合彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumber49M6", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab08.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def contentLotto539() { //今彩539介紹
        params.pType = "107"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab09.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistoryLotto539() { //今彩539歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistoryLotto539", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab09.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinueLotto539() { //今彩539連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinueLotto539", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab09.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeatLotto539() { //今彩539連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeatLotto539", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab09.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumberLotto539() { //今彩539尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumberLotto539", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab09.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def content39M5() { //39樂合彩介紹
        params.pType = "108"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab10.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistory39M5() { //39樂合彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistory39M5", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                          nw300IL   : vLastOpenData.list, nw300ILMax: vLastOpenData.maxNum,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab10.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customContinue39M5() { //39樂合彩連續分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customContinue39M5", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomContinue1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                           nw300I    : vHistoryData.list,
                                                           nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                           pType     : params.pType, title: g.message(code: "lotto.tab10.subTab04.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customRepeat39M5() { //39樂合彩連開分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customRepeat39M5", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomRepeat1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                         nw300I    : vHistoryData.list,
                                                         nw300IC   : vCntsData.list, nw300ICMax: vCntsData.maxNum,
                                                         pType     : params.pType, title: g.message(code: "lotto.tab10.subTab03.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }
    ...
    def customLastNumber39M5() { //39樂合彩尾數分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customLastNumber39M5", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomLastNumber1", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs,
                                                             nw300I    : vHistoryData.list,
                                                             nw300ILN  : vLastNumberData.list, nw300ILNMax: vLastNumberData.maxNum, createColumn: vLastNumberData.createColumn, columnsCNTS: vLastNumberData.columnsCNTS,
                                                             pType     : params.pType, title: g.message(code: "lotto.tab10.subTab05.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def content3D() { //3星彩介紹
        params.pType = "109"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab11.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistory3D() { //3星彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistory3D", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory3", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnIDXS: vHistoryData.columnIDXS, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab11.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def content4D() { //4星彩介紹
        params.pType = "110"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab12.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }
    ...
    def customHistory4D() { //4星彩歷史數據分析
        ...
        def vLink = g.createLink(controller: "lotto", action: "customHistory4D", params: [lv1IDX: params.int('lv1IDX'), lv2IDX: params.int('lv2IDX')])
        render view: "/lotto/formCustomHistory3", model: [totalCount: vHistoryData.counts, columnsNOs: vHistoryData.columnsNOs, columnIDXS: vHistoryData.columnIDXS, showSpBtn: "0",
                                                          nw300I    : vHistoryData.list,
                                                          pType     : params.pType, title: g.message(code: "lotto.tab12.subTab02.label"), lv1IDX: params.int('lv1IDX'), pLink: vLink]
    }

    def contentBingoBingo() { //賓果介紹
        params.pType = "111"
        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formContent1", model: [nw400I: nw400I, title: g.message(code: "lotto.tab13.subTab01.label"), lv1IDX: params.int('lv1IDX')]
    }

    def customOpenNumBingo() { //賓果開獎號碼
        params.pType = "111"
//        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formCustomOpenNum1", model: [title: g.message(code: "lotto.tab13.subTab02.label"), lv1IDX: params.int('lv1IDX')]
    }

    def customStatistBingo() { //賓果開獎/未開獎統計
        params.pType = "111"
//        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formCustomStatist1", model: [title: g.message(code: "lotto.tab13.subTab03.label"), lv1IDX: params.int('lv1IDX')]
    }

    def customAnalysisBingo() { //賓果綜合分析
        params.pType = "111"
//        def nw400I = netWinService.getNw400List(params)
        render view: "/lotto/formCustomAnalysis1", model: [title: g.message(code: "lotto.tab13.subTab04.label"), lv1IDX: params.int('lv1IDX')]
    }
