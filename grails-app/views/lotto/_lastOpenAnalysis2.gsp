            ...
            <table border="1" style="width: 100%">
                ...
                <g:each var="i" in="${(columnsNOs)}">
                    ...
                    <td class="tbody4td pull-down lottoTD" style=" height: 100px">
                        ...
                        <div class="linepercentEver" style="height: ${(75 * (nw300SERIALI[0]?."NO${pNum}")) / maxNum}px;"/>
                    </td>
                </g:each>
                <g:each var="i" in="${(columnsSPNOs)}">
                    <g:set var="pNum" value="${g.formatNumber(number: i, format: "00")}"/>
                    <td class="tbody4td pull-down lottoTD" style=" height: 100px">
                        ...
                        <div class="linepercentEver" style="height: ${(75 * (nw300SERIALI[0]?."SPNO${pNum}")) / maxNum}px;"/>
                    </td>
                </g:each>
                </tbody>
