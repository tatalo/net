...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <table border="1" style="width: 100%">
            ...
            <g:render template="/lotto/lottoDataTitleList2" model="[columnsNOs: columnsNOs, columnsSPNOs: columnsSPNOs, nw300I: nw300I]"/>
            <g:render template="/lotto/lottoDataCntsList2"
                      model="[columnsNOs: columnsNOs, columnsSPNOs: columnsSPNOs, nw300IC: nw300IC, nw300ICMax: nw300ICMax]"/>
            <g:render template="/lotto/lottoDataLastOpenList2"
                      model="[columnsNOs: columnsNOs, columnsSPNOs: columnsSPNOs, nw300IL: nw300IL, nw300ILMax: nw300ILMax]"/>
        </table>
    </div>
</div>
