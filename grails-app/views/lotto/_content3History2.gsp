<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group text-right">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target="#modalYYYYMM_${divId}">日期查詢</button>
        </div>
...
<div id="modalYYYYMM_${divId}" class="modal" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:datePicker id="P_YYYYMM_${divId}" name="P_YYYYMM_${divId}" precision="day" value="${new Date()}"
                              years="${df.yyyList()}"/>
            </div>

            <div class="modal-footer">
                <button class="btn btn-primary"
                        onclick="getLottoHistory('${pTab}', '${pSubTab}', '${pType}', '${divId}', 'modalYYYYMM_${divId}', '3');">查詢</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">關閉</button>
            </div>
        </div>
    </div>
