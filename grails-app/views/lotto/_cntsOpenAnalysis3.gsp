    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="pull-right">
                <g:remoteLink class="btn btn-primary" action="cntsOpenAnalysis3Filter"
        ...
        <div class="table-responsive">
            ...
            <table border="1" style="width: 100%">
                ...
                <tbody id="tbody4">
                <th class="lottoTitleCNTS" colspan="4">
                    ...
                    <g:each var="Num" in="${(columnsNOs)}">
                        <td class="tbody4td pull-down lottoTD">
                            <div class="text-center">
                                ${nw300CNTSI[0]?."NO${IDX}${Num}"}
                            </div>

                            <div class="linepercent"
                                 style="height: ${(75 * (nw300CNTSI[0]?."NO${IDX}${Num}")) / maxNum}px;"/>
                        </td>
                    </g:each>
                </g:each>
                </tbody>
